...
<template>
  <button
    ...
    accept="image/*"
    type="button"
    class="block w-full p-0 ring-3 ring-transparent hover:ring-gray-300 focus:ring-gray-300 rounded-2xl transition overflow-hidden"
  ...
  >
    <div class="h-64 w-full bg-light-300 flex items-center justify-center">
      ...
      <p v-else class="text-gray-300">Press 'Enter' to upload image</p>
    </div>
  </button>
</template>
